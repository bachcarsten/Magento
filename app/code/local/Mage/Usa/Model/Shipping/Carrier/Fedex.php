...
/*
 * Edited by Goodahead: model rewritted because default Shipping Labels size is hardcoded.
 * Module: Goodahead_Shipping
 *
 * Added:
 *
 *  //<<Custom
 *  $store = Mage::app()->getStore();
 *  $labelSize = Mage::getStoreConfig('fedex_shipping/general/label_format', $store);
 *  //Custom>>
 *
 *  ...
 *
