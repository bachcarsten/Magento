    ...
    extends Mage_Core_Model_Resource_Setup
{
    ...
    public function applyDataUpdates()
    {
        ...
        Mage::register('goodahead_core_cms_update', true, true);

        $cmsConfig = new Varien_Simplexml_Config;
        $cmsConfig->loadString('<?xml version="1.0"?><config><global><goodahead><core>'
            . '<cms><block></block><page></page></cms></core></goodahead></global></config>');
        ...
        Mage::unregister('goodahead_core_cms_update', true);
