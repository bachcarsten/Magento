...
class Ess_M2ePro_Model_AttributeSet extends Ess_M2ePro_Model_Abstract
{
    ...
    const OBJECT_TYPE_AMAZON_CATEGORY             = 5;
    const OBJECT_TYPE_AMAZON_CATEGORY_DESCRIPTION = 6;
    ...
    public function isAmazonCategory()
    {
        return $this->getObjectType() == self::OBJECT_TYPE_AMAZON_CATEGORY;
    }

    public function isAmazonCategoryDescription()
    {
        return $this->getObjectType() == self::OBJECT_TYPE_AMAZON_CATEGORY_DESCRIPTION;
    }
