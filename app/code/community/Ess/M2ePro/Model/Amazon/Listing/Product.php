...
class Ess_M2ePro_Model_Amazon_Listing_Product extends Ess_M2ePro_Model_Component_Child_Amazon_Abstract
{
    ...
    /**
     * @return Ess_M2ePro_Model_Amazon_Category
    */
    public function getCategory()
    {
        return Mage::getModel('M2ePro/Amazon_Category')->loadInstance((int)$this->getCategoryId());
    }
    ...
    */
    ...
    {
        return $this->getCategory()->getSource($this);
    }
