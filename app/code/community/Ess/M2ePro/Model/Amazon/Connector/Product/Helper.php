...
class Ess_M2ePro_Model_Amazon_Connector_Product_Helper
{
    ...
    public function getListRequestData(Ess_M2ePro_Model_Listing_Product $listingProduct, array $params = array())
    {
        ...
        /* @var $categorySourceInstance Ess_M2ePro_Model_Amazon_Category_Source */
        $categorySourceInstance = $listingProduct->getChildObject()->getCategorySource();

        $requestData['product_data'] = $categorySourceInstance->getProductData();
        $requestData['description_data'] = $categorySourceInstance->getDescriptionData();
        $requestData['images_data'] = $categorySourceInstance->getImagesData();
