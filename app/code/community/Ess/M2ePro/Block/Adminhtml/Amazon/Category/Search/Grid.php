...
class Ess_M2ePro_Block_Adminhtml_Amazon_Category_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('amazonCategorySearchGrid');
        //------------------------------
...
<div style="margin-left: 3px">
    <a href="javascript:;" onclick="AmazonCategoryHandlerObj.confirmSearchClick($categoryInfo)">$title</a>
    <br>
...
HTML;
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $html = <<<HTML
<a href="javascript:;" onclick="AmazonCategoryHandlerObj.confirmSearchClick($categoryInfo)">$select</a>
HTML;
...
<script type="text/javascript">
    ...
    $$('#amazonCategorySearchGrid div.grid th').each(function(el){
        el.style.padding = '2px 2px';
    });

    $$('#amazonCategorySearchGrid div.grid td').each(function(el){
        el.style.padding = '2px 2px';
    });
