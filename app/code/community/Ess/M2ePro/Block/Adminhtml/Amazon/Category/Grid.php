...
class Ess_M2ePro_Block_Adminhtml_Amazon_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('node_title', array(
            'header'       => Mage::helper('M2ePro')->__('Departament'),
            'align'        => 'left',
            'type'         => 'text',
            'width'        => '100px',
            'index'        => 'node_title',
    ...
    public function callbackColumnAttributeSets($value, $row, $column, $isExport)
    {
        $attributeSets = Mage::getModel('M2ePro/AttributeSet')->getCollection()
            ->addFieldToFilter('object_type',Ess_M2ePro_Model_AttributeSet::OBJECT_TYPE_AMAZON_CATEGORY)
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $listingProductIds = array_filter(explode(',',$listingProductIds));
