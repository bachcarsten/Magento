...
class IllApps_Shipsync_Model_Shipping_Carrier_Fedex extends Mage_Usa_Model_Shipping_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
	...
	// Collect rates
	Varien_Profiler::start('collect_rates_shipsync');
	$result = Mage::getModel('usa/shipping_carrier_fedex_rate')->collectRates($request);
	Varien_Profiler::stop('collect_rates_shipsync');
	return $result;
    }
...
// 	    $this->setWsdlPath(dirname(__FILE__) . '/Fedex/wsdl/test/' . $wsdlPath);
	    $this->setWsdlPath(Mage::getModuleDir('data', 'IllApps_Shipsync') . DS . 'wsdl' . DS . 'test' . DS . $wsdlPath);
	}
	else
	{
...
// 	    $this->setWsdlPath(dirname(__FILE__) . '/Fedex/wsdl/' . $wsdlPath);
	    $this->setWsdlPath(Mage::getModuleDir('data', 'IllApps_Shipsync') . DS . 'wsdl' . DS . $wsdlPath);
