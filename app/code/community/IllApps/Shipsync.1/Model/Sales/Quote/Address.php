...
class IllApps_Shipsync_Model_Sales_Quote_Address extends Mage_Sales_Model_Quote_Address
{
    ...
    {
	/** Filter PO Boxes */
        if ($this->getStreet(-1) && Mage::getStoreConfig('carriers/fedex/filter_po_boxes')
	...
	/** If country is US, street is present, and address validation is enabled */
        if (($this->getCountryId() == 'US') && $this->getStreet(-1) && Mage::getStoreConfig('carriers/fedex/address_validation'))
        {
