    ...
    public function unparse()
    {
        ...
        foreach ($entityIds as $i => $entityId) {
            ...
            if($row['billing_company'])
                $temp1 = $row['billing_company'];            
            if($row['shipping_company'])
                $temp2 = $row['shipping_company'];                
            if($row['billing_company'] == $preBillingCompany){
                $row['billing_company'] = '';
            }     
            if($row['shipping_company'] == $preShippingCompany){
            ...
            $preBillingCompany = $temp1;
            $preShippingCompany = $temp2;
        }
